        ...
        <center>
            ...
            <div class="row">
                <div class="col-10">
                    ...
                    <center>
                        <q-slider :step="1"  style="width:90%;margin-top:-5px" v-model="zoom_value"  :min="0" :max="10" color="blue" />
                    </center>
                </div>
                <div class="col-1">
...
<script>
import VueCropper from "../../pages/vue-cropper/vue-cropper";
export default {
    name: 'CropAlert',
    props: ['imageUrl'],
    data(){
    ...
    components: {
        Avatar: require("../images/Avatar.vue").default,
        Separator: require("../Separator.vue").default,
        VueCropper
    },
    created(){
